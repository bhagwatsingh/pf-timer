...
class PFTimer {
	...
	$links = array_merge( array(
		'<a href="' . esc_url( admin_url( '/edit.php?post_type=pf_timer' ) ) . '">' . __( 'Settings', 'textdomain' ) . '</a>'
	), $links );
	...
	function pf_timer_post_sett_metabox() {
		add_meta_box( 'pf-timer-post-sett', __( 'PF Timer Settings - Settings', PF_TIMER_POST_TYPE ), array($this, 'pf_timer_post_sett_mb_content'), PF_TIMER_POST_TYPE, 'normal', 'high' );
	}
	...
	function pf_timer_save_metabox_value($post_id){
		update_post_meta($post_id, 'pf_timer_subtitle', isset($_POST['pf_timer_subtitle'])? $_POST['pf_timer_subtitle']:'');
		update_post_meta($post_id, 'pf_timer_expiry_date', isset($_POST['pf_timer_expiry_date'])? $_POST['pf_timer_expiry_date']:'');
		update_post_meta($post_id, 'pf_timer_timezone', isset($_POST['pf_timer_timezone'])? $_POST['pf_timer_timezone']:'');
		update_post_meta($post_id, 'pf_timer_redirect_url', isset($_POST['pf_timer_redirect_url'])? $_POST['pf_timer_redirect_url']:'');
		update_post_meta($post_id, 'pf_timer_border_radius', isset($_POST['pf_timer_border_radius'])? $_POST['pf_timer_border_radius']:'');
		update_post_meta($post_id, 'pf_timer_bg_color', isset($_POST['pf_timer_bg_color'])? $_POST['pf_timer_bg_color']:'');
		update_post_meta($post_id, 'pf_timer_font_color', isset($_POST['pf_timer_font_color'])? $_POST['pf_timer_font_color']:'');
		update_post_meta($post_id, 'pf_timer_font_size', isset($_POST['pf_timer_font_size'])? $_POST['pf_timer_font_size']:'');
    }
}
